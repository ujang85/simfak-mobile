...
use app\models\DataGedungPMSearch;
 ...
 */
class DataGedungPmController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    {    
        $searchModel = new DataGedungPMSearch();
    ...
    public function actionUpdate($id)
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Jadwal PM Sarana Bangunan ",
    ...
    {
        $modeljadwal = new JadwalPm(); 
        $model = $this->findModel($inven_rs);

       if ($model->load(Yii::$app->request->post()) )
        {
            $modeljadwal->inven_rs = $model->inven_rs;
      ...
      //      $modelperiksa->save();
        ...
        $searchModel = new AlatMedisKalibrasiSearch();
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams);
