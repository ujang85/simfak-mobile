...
use app\models\AduanSanitasiSearch;
 ...
 */
class AduanAlatSanitasiController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    {    
        ...
        $searchModel2 = new AduanSanitasiSearch();
            ...
            if($request->isGet){
                return [
                    ...
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
                     ...
                     $aduan->group_id = $model->kode_group;
