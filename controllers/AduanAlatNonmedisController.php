...
use app\models\AlatNonmedisSearch;
use app\models\AduanNonmedisSearch;
 ...
 */
class AduanAlatNonmedisController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    {    
        $searchModel = new AlatNonmedisSearch();
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams);
        // utk setting pagination letakkan disini 
        $dataProvider->pagination->pageSize=5;

        $searchModel2 = new AduanNonmedisSearch();
    ...
    {   
       $pdf=new pdf([
        ...
        'content'=>$this->renderPartial('cetak-laporan',
