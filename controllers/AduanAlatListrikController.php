...
use app\models\AlatListrikSearch;
use app\models\AduanListrikSearch;
 ...
 */
class AduanAlatListrikController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    {    
        $searchModel = new AlatListrikSearch();
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams);
        // utk setting pagination letakkan disini 
        $dataProvider->pagination->pageSize=5;

        $searchModel2 = new AduanListrikSearch();
