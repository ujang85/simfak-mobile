...
class AduanController extends Controller
{
    ...
    protected function findMaster($id)
    {
    ...
    public function actionCetak($id)
     {
        $pdf = new Pdf([
           ...
           // 'mode' => Pdf::MODE_ASIAN,
            ...
            'content' => $this->renderPartial('cetak3',
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "Create new Aduan",
                    'content'=>'<span class="text-success">Create Aduan success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
            ...
            */
            if ($model->load($request->post()) && $model->save()) {
                return $this->redirect(['view', 'id' => $model->kd_lapor]);
            } else {
    ...
    /**
     * Delete an existing Aduan model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing Aduan model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
