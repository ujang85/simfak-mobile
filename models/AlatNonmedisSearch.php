 ...
 */
class AlatNonmedisSearch extends AlatRs
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['kode_alat',  'th_pengadaan','kalibrasi', 'hrg_peroleh', 'periode_pm', 'id_suplayer', 'kode_group', 'periode_kl', 'konversi_pm', 'cost_tahun', 'konversi_kl', 'id_org'], 'integer'],
