 ...
 */
class AduanGedungSearch extends Aduan
{
    /**
     * @inheritdoc
     */
   ...
   //public $user;
    ...
    public function rules()
    {
        return [
            ...
            [['merk_type','nama_gedung','isi_lapor', 'tgl_lapor', 'jam_lapor', 'inven_id', 'nama_komp', 'teknisi', 'Keterangan', 'tgl_respon', 'jam_respon', 'tgl_selesai', 'jam_selesai'], 'safe'],
        ];
    }
